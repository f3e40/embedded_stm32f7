...
pub struct Tim2 {
    ...
    pub or1: volatile::ReadWrite<Or1>,
    _reserved2: [u8; 12usize],
    # [ doc = "0x60 - TIM2 option register 2" ]
    pub or2: volatile::ReadWrite<Or2>,
}
...
impl Or1 {
    ...
    pub fn etr1_rmp(&self) -> bool {
        self.bits.get_bit(1u8)
    }
    # [ doc = "Bit 0 - Internal trigger 1 remap" ]
    pub fn itr1_rmp(&self) -> bool {
        self.bits.get_bit(0u8)
    }
}

impl Default for Or1 {
    # [ doc = r" Reset value" ]
    fn default() -> Self {
        Or1 { bits: 0u32 }
    }
...
impl Or1 {
    # [ doc = "Bits 2:3 - Input Capture 4 remap" ]
    pub fn set_ti4_rmp(&mut self, value: u8) {
        self.bits.set_range(2u8..4u8, value as u32);
    }
    # [ doc = "Bit 1 - External trigger remap" ]
    pub fn set_etr1_rmp(&mut self, value: bool) {
        self.bits.set_bit(1u8, value);
    }
    # [ doc = "Bit 0 - Internal trigger 1 remap" ]
    pub fn set_itr1_rmp(&mut self, value: bool) {
        self.bits.set_bit(0u8, value);
    }
}
...
impl Or2 {
    # [ doc = "Bits 14:16 - ETR source selection" ]
    pub fn set_etrsel(&mut self, value: u8) {
